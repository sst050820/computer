var VueArchiveSearch = {
  ...
  template: '<div class="card"><div class="card-header"><i class="fas fa-search card-icon" style="background:#e0f2fe;color:var(--co-info);"></i><span class="card-title">产品档案全链路查询</span></div>' +
    ...
    '<button @click="doSearch" style="display:inline-flex;align-items:center;gap:6px;padding:10px 24px;border:none;border-radius:var(--rd-md);font-size:0.88rem;font-weight:600;cursor:pointer;background:linear-gradient(135deg,#C53030,#D14343);color:#fff;box-shadow:0 2px 8px rgba(197,48,48,0.25);transition:all 0.2s;" onmouseover="this.style.transform=\'translateY(-1px)\';this.style.boxShadow=\'0 4px 14px rgba(197,48,48,0.35)\'" onmouseout="this.style.transform=\'none\';this.style.boxShadow=\'0 2px 8px rgba(197,48,48,0.25)\'"><i class="fas fa-search"></i> 查询</button></div>' +
