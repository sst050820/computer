var VueContentAudit = {
  ...
  template: '<div class="card"><div class="card-header"><i class="fas fa-eye card-icon" style="background:#f3e8ff;color:#6b21a8;"></i><span class="card-title">内容审核</span></div>' +
    ...
    '<td><button @click="remove(p)" style="display:inline-flex;align-items:center;gap:4px;padding:6px 14px;border:1.5px solid #e0c0c0;border-radius:var(--rd-sm);font-size:0.8rem;font-weight:500;cursor:pointer;background:#fff;color:#B85450;transition:all 0.2s;" onmouseover="this.style.background=\'#fef5f5\';this.style.borderColor=\'#D14343\';this.style.color=\'#D14343\'" onmouseout="this.style.background=\'#fff\';this.style.borderColor=\'#e0c0c0\';this.style.color=\'#B85450\'"><i class="fas fa-ban"></i> 下架</button></td></tr></tbody></table>' +
    ...
    '<td><button @click="removeCustom(c)" style="display:inline-flex;align-items:center;gap:4px;padding:6px 14px;border:1.5px solid #e0c0c0;border-radius:var(--rd-sm);font-size:0.8rem;font-weight:500;cursor:pointer;background:#fff;color:#B85450;transition:all 0.2s;" onmouseover="this.style.background=\'#fef5f5\';this.style.borderColor=\'#D14343\';this.style.color=\'#D14343\'" onmouseout="this.style.background=\'#fff\';this.style.borderColor=\'#e0c0c0\';this.style.color=\'#B85450\'"><i class="fas fa-ban"></i> 删除</button></td></tr></tbody></table>' +
