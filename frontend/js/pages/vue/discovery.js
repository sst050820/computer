...
const VueDiscovery = {
  ...
  template: '<div class="page-discovery">' +
    ...
    '<div class="prod-img"><img v-if="getImgSrc(p)" :src="getImgSrc(p)" style="width:100%;height:100%;object-fit:cover;" :alt="p.name" /><span v-else>{{ getEmoji(p) }}</span><span v-if="p.certification" class="prod-tag">{{ p.certification }}</span></div>' +
    '<div class="prod-body">' +
    ...
    '<img v-if="getImgSrc(detailProduct)" :src="getImgSrc(detailProduct)" style="max-width:200px;max-height:200px;border-radius:var(--rd-md);object-fit:cover;" :alt="detailProduct.name" /><div v-else style="font-size:5rem;padding:20px;">{{ getEmoji(detailProduct) }}</div>' +
  ...
  data: function() {
    return {
      ...
      activeCat: '', catMap: { tea:'茶叶',fruit:'果蔬',grain:'谷物',meat:'畜牧',snack:'零食',mushroom:'菌菇' },
      catOptions: ['茶叶','果蔬','谷物','畜牧','零食','菌菇'],
      originOptions: ['三明','南平','宁德','福州','龙岩','莆田','泉州','漳州','厦门'],
      searchKeyword: '', searchCategory: '', searchOrigin: '',
      products: [], loading: true,
      defaultProducts: [
        { id:'s1',name:'安溪铁观音',category:'茶叶',origin:'泉州',price:298,shop_name:'泉州农产品',shop_id:'m07',certification:'有机',image:'🍵',sales:2340 },
        { id:'s2',name:'古田油奈李',category:'果蔬',origin:'宁德',price:45,shop_name:'宁德农产品',shop_id:'m03',certification:'无公害',image:'🫐',sales:5600 },
        { id:'s3',name:'三明红菇',category:'菌菇',origin:'三明',price:188,shop_name:'三明农产品',shop_id:'m01',certification:'绿色',image:'🍄',sales:1200 },
        { id:'s4',name:'福州茉莉花茶',category:'茶叶',origin:'福州',price:198,shop_name:'福州农产品',shop_id:'m04',certification:'绿色',image:'🍵',sales:4500 },
        { id:'s5',name:'建宁莲子',category:'谷物',origin:'三明',price:148,shop_name:'三明农产品',shop_id:'m01',certification:'绿色',image:'🌾',sales:3200 },
        { id:'s6',name:'武夷山竹荪',category:'菌菇',origin:'南平',price:258,shop_name:'南平农产品',shop_id:'m02',certification:'有机',image:'🍄',sales:890 },
        { id:'s7',name:'莆田荔枝',category:'果蔬',origin:'莆田',price:88,shop_name:'莆田农产品',shop_id:'m06',certification:'绿色',image:'🍒',sales:6700 },
        { id:'s8',name:'南平熏鹅',category:'畜牧',origin:'南平',price:98,shop_name:'南平农产品',shop_id:'m02',certification:'绿色',image:'🥩',sales:2100 },
        { id:'s9',name:'漳州莲雾',category:'果蔬',origin:'漳州',price:128,shop_name:'漳州农产品',shop_id:'m08',certification:'绿色',image:'🍑',sales:1500 },
        { id:'s10',name:'厦门树葡萄',category:'果蔬',origin:'厦门',price:158,shop_name:'厦门农产品',shop_id:'m09',certification:'绿色',image:'🍇',sales:2800 },
        { id:'s11',name:'福安穆阳水蜜桃',category:'果蔬',origin:'宁德',price:108,shop_name:'宁德农产品',shop_id:'m03',certification:'绿色',image:'🍑',sales:3400 },
        { id:'s12',name:'龙岩花生',category:'谷物',origin:'龙岩',price:32,shop_name:'龙岩农产品',shop_id:'m05',certification:'绿色',image:'🥜',sales:12000 },
      ],
      emojiMap: { '茶叶':'🍵','果蔬':'🍎','谷物':'🌾','畜牧':'🥩','菌菇':'🍄','零食':'🍪' },
      bannerTimer: null
    };
  },
  mounted: function() {
